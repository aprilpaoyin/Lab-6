...
{	
	...
	while(1) 
	{
		...
		else
		{
			if(button == '*')
			{
				DisplayMemory[0] = SEG_E + SEG_G;
				DisplayMemory[1] = SEG_A + SEG_B + SEG_C + SEG_E + SEG_F + SEG_G;
				DisplayMemory[2] = SEG_D + SEG_E + SEG_F + SEG_G;
				DisplayMemory[3] = SEG_A + SEG_C + SEG_D + SEG_F + SEG_G;
			}//end if
			else if(button == '#')
			{
				DisplayMemory[0] = SEG_B + SEG_C + SEG_E + SEG_F + SEG_G;
				DisplayMemory[1] = SEG_A + SEG_C + SEG_D + SEG_F + SEG_G;
				DisplayMemory[2] = SEG_A + SEG_B + SEG_C + SEG_E + SEG_F + SEG_G;
				DisplayMemory[3] = SEG_B + SEG_C + SEG_E + SEG_F + SEG_G;
			}//end else if
